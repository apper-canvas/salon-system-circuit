...
const ErrorPage = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background">
      <div className="w-full max-w-md p-8 bg-surface rounded-lg shadow-salon text-center">
        <h1 className="text-2xl font-bold text-red-600 mb-4 font-display">Authentication Error</h1>
